        ...
        <>
            <div className="max-w-md mx-auto p-6 bg-white rounded-md shadow-md">
                ...
                <form onSubmit={handleSubmit} className="mt-4">
                    ...
                    <div className="mb-4">
                        <label htmlFor="receipt" className="block">Receipt</label>
                    ...
                    <div className="mb-4">
                        <label htmlFor="amountPaid" className="block">Amount Paid (FRW)</label>
                        <input type="text" id="amountPaid" name="amountPaid" value={formData.amountPaid} onChange={handleChange} className="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-blue-500" required />
                    </div>
                    <div className="mb-4">
